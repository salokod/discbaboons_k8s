...
import { authRateLimit, passwordRateLimit } from '../middleware/authRateLimit.middleware.js';
...
router.post('/forgot-username', passwordRateLimit, restrictiveRequestLimit, forgotUsernameController);
